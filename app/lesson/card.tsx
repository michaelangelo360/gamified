...
import {useAudio ,useDropArea,useKey} from "react-use";
...
export const Card =({
    ...
    return(
        ...
        >
            {audio}
        { imageSrc &&( //remember i changed the alt option from {text} to no image found
            <div
            className="relative aspect-square mb-4 max-h-[80px] lg:max-h-[150px] w-full"
            >

             <Image src={imageSrc} fill alt="No Image found">  
